...
export async function handleDataReceptionInput(
  event: ALBEvent,
  _context: Context,
  ...
  const s3 = new S3();
  try {
    // TODO: take event including input file
    // TODO: do simple validation, try to validate zip? but requires reading to memory
    // TODO: upload to s3
