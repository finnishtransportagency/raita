...
export function convertDataToRcMittausArray(data: any[]): RcMittausData[] {
  return data.map(item => ({
    ...
    vasen_raiteen_aallon_rms_30_100mm_keskihajonta: sanitizeValue(
      ...
      : null,
    oikea_raiteen_aallon_rms_100_300mm_keskihajonta: sanitizeValue(
      item.oikea_raiteen_aallon_rms_100_300mm_keskihajonta,
    )
      ? new Decimal(
          sanitizeValue(item.oikea_raiteen_aallon_rms_100_300mm_keskihajonta),
        )
      : null,
...
export function convertDataToRpMittausArray(data: any[]): rp_mittaus[] {
  return data.map(item => ({
    ...
    vasen_1_3_yhdistetyn_sivuttaiskuluman_keskihajonta: sanitizeValue(
      ...
      : null,
    oikea_1_3_yhdistetyn_sivuttaiskuluman_keskihajonta: sanitizeValue(
...
export function convertDataToTsightMittausArray(data: any[]): TsightMittaus[] {
  return data.map(item => ({
    ...
    jarjestelma: sanitizeValue(item.jarjestelma) ? item.jarjestelma : null,
    sscount: sanitizeValue(item.sscount) ? parseInt(item.sscount, 10) : null,
