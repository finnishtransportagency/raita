...
export default function Selector(props: Props) {
  ...
  const addFilter = () =>
    setState(s =>
      R.assoc(
        'filters',
        R.append({ field: EMPTY_KEY, value: '', type: 'String' }, s.filters),
        s,
      ),
    );
  ...
  const updateFilter = (
    ...
    setState(currentState => {
      const fieldData: Partial<Entry> = { field, type };
      if (value) {
...
// types from graphql
export type SelectorSupportedType =
  | 'String'
  | 'Int'
  | 'IntIntervalInput'
...
// TODO: remove this later when not used
...
export type FieldTypeT = SelectorSupportedType;
