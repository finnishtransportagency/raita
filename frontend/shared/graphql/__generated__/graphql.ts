...
export type Search_Mittaus_CountQuery = { __typename?: 'Query', search_mittaus_count: { __typename?: 'MittausCountResponse', status: string, row_count: number, size_estimate: number } };
